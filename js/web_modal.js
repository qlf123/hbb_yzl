...
function　addModal() {
	$("body").append(
		...
		'<div class="modal-dialog" style="top:50%; left:50%; width:200px; height: 50px; margin-top: -30px; margin-left: -100px;">' +
		'<div class="modal-content" style="border:0;">' +
		'<div class="modal-header" style="padding:0;">' +
		'<p style="line-height: 50px;text-align: center; font-family: MyNewFont;">保存成功</p>' +
		'</div>' +
		'</div>' +
		'</div>' +
		'</div>'+
		'<div  class="modal fade" id="yhx-save-prompt" tabindex="-1" role="dialog"  aria-hidden="true">' +
		'<div class="modal-dialog" style="top:50%; left:50%; width:260px; height: 100px; margin-top: -50px; margin-left: -130px;">' +
		'<div class="modal-content" style="border:0;">' +
		'<div class="modal-header" style="padding:0;">' +
		'<p style="height: 100px; text-align: center; font-family: MyNewFont;"><span style="display: block;line-height: 60px;">还有模板未编辑，是否保存</span><span id="yhx-save-yes" class="yhx-save-btn">是</span><span id="yhx-save-no" class="yhx-save-btn">否</span></p>' +
		'</div>' +
		'</div>' +
		'</div>' +
		'</div>');
